...
export default function Navbar() {
    ...
    return (
        <nav >
            <div className='flex h-fit py-5 items-center justify-around pb-10 '>
                ...
                <ul className='flex gap-10'>
                    <li className='relative inline-block cursor-pointer group hover:text-blue-600' onClick={()=> navigate('/')}>Home
                        <span className="absolute left-0 bottom-0 w-full h-0.5 bg-blue-500 scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span>
                    </li>
